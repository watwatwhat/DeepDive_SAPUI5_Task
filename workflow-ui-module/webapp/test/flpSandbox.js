		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ordersmgtsnpworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ordersmgtsnpworkflowuimodule-display": {
								"semanticObject": "ordersmgtsnpworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ordersmgtsnp.workflowuimodule",
									"url": sap.ui.require.toUrl("ordersmgtsnp/workflowuimodule")
								}
							}
						}
					}
